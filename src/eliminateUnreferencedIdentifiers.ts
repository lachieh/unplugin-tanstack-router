...
/**
 * @param programPath - The root path of the program.
 * @param refs - If provided, only these identifiers will be considered for removal.
 */
export function eliminateUnreferencedIdentifiers(programPath: NodePath<BabelTypes.Program>, refs?: Set<IdentifierPath>) {
